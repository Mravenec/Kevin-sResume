...
const translations = {
    ...
    es: {
        ...
        languages: 'Idiomas',
        profile: [
            'Ingeniero de software back-end con sólida experiencia construyendo aplicaciones web escalables usando Java, Spring Boot y tecnologías .NET. Comprobada experiencia en desarrollo de APIs RESTful, integración de plataformas CMS y diseño de soluciones de bases de datos robustas. Apasionado por aprovechar tecnologías modernas y herramientas de IA generativa para mejorar la productividad del desarrollo y entregar soluciones de alta calidad en entornos de rápido movimiento.',
